...
type_t *make_complex_type(atomic_type_kind_t type,
                          type_qualifiers_t qualifiers);
type_t *make_imaginary_type(atomic_type_kind_t type,
                            type_qualifiers_t qualifiers);
...
static inline bool is_type_atomic(const type_t *type,
                                  atomic_type_kind_t atype) {
